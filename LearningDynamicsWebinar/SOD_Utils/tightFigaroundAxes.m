function tightFigaroundAxes( handles )
% From: https://stackoverflow.com/questions/18832406/remove-deadspace-or-increase-size-of-figure-in-subplot
%   Inputs:
%
...
% TODO: Make squeeze axes compatible with axes that occupy multiple subplot places.
...
% Set OuterPosition to occupy as most space as possible
      curAxesOuterPos = [leftPos(curColumn) botPos(curLine) subplotWidth subplotHeight];
      set(curAxes, 'OuterPosition', curAxesOuterPos);
% Remove dead space inside subplot border:
      curAxesTightPos = get(curAxes, 'TightInset');
      noDeadSpacePos  = curAxesOuterPos + [curAxesTightPos(1:2) -(curAxesTightPos(1:2) + curAxesTightPos(3:4))];
