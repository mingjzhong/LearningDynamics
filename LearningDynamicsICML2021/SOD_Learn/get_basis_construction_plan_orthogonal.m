function basis_plan = get_basis_construction_plan_orthogonal(phi_range, rhoLTM, learn_info)
% function basis_plan = get_basis_construction_plan_orthogonal(phi_range, rhoLTM, learn_info)
...
for idx = 1 : num_kinds
  ...
  for k1 = 1 : learn_info.sys_info.K
    for k2 = 1 : learn_info.sys_info.K
      ...
      basis_plan{idx}{k1, k2}.inner_prod = @(f, g) get_inner_product_wrt_rho(f, g, ...
                                           phi_range{idx}{k1, k2}, rhoLTM{idx}{k1, k2});
