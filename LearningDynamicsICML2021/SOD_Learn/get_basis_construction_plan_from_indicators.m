function basis_plan = get_basis_construction_plan_from_indicators(phi_range, knots, indicators, ...
                      learn_info)
% function basis_plan = get_basis_construction_plan_from_indicators(phi_range, knots, indicators, ...
%                       learn_info)
...
for idx = 1 : num_kinds
  ...
  for k1 = 1 : learn_info.sys_info.K
    for k2 = 1 : learn_info.sys_info.K
      basis_plan{idx}{k1, k2}.indica = indicators{idx}{k1, k2};
      ext_knots                      = get_knots_from_indicators(knots{idx}{k1, k2}, ...
                                        basis_plan{idx}{k1, k2}.indica);
