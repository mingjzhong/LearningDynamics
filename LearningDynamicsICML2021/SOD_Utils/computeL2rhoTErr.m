...
if (isfield(sys_info, 'phiE') && ~isempty(sys_info.phiE)) && ...
  ...
  L2rhoTErr.EAErr       = relativeErrorInfluenceFunction({Estimator.phiEhat, Estimator.phiAhat}, ...
                          {sys_info.phiE, sys_info.phiA}, sys_info, obs_info, {Estimator.Ebasis, ...
                          Estimator.Abasis}, 'energy_and_alignment');
  L2rhoTErr.EAErrSmooth = relativeErrorInfluenceFunction({Estimator.phiEhatsmooth, ...
                          Estimator.phiAhatsmooth}, {sys_info.phiE, sys_info.phiA}, sys_info, ...
                          obs_info, {Estimator.Ebasissmooth, Estimator.Abasissmooth}, ...
                          'energy_and_alignment');
end
