...
size_of_r           = size(r);                                                                      % find out the size of the r matrix 
phihat              = zeros(size_of_r);                                                             % prepare phihat, having the same size as the independent variable r
