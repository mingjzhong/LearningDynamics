function Example = OpinionDynamicsContonPD_LDoM_def()
% function Example = OpinionDynamicsContonPD_LDoM_def()
% Define associated terms for OPINION DYNAMICS Continuous on Poincare Disk

% (c) M. Zhong

% System
sys_info.name                = 'OpinionDynamicsContonPD';                                           % name of the dynamics
