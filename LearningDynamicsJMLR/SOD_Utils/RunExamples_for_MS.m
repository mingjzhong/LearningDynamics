...
if ExampleIdx == 1 || ExampleIdx == 2
  ...
  displayMSLearningResults(learningOutput{1}, plot_info);
%% Save
  save(sprintf('%s/%s_learningOutput%s.mat', SAVE_DIR, sys_info.name, time_stamp), '-v7.3', 'sys_info', 'solver_info', 'obs_info', 'learn_info', 'obs_data', 'learningOutput');  
