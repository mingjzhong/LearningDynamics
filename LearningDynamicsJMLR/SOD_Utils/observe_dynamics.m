...
%     if ~isfield(obs_info,'h')
%     [traj1, ~]   = deval( solution, obs_info.time_vec+obs_info.h);  % find out the trajectory position and derivative at those time instances
%     dtraj  = (traj1-traj)./obs_info.h;
%     end
