function Psi = assemble_the_learning_matrix_on_xi(energy_pdist, xi_pdiff, xi_regulator, xi_basis, time_vec, agents_info, Psi_row_ind, sys_info)
...
% \phi_l(|x_j - x_i|)(x_j - x_i) or \phi_l(|x_j - x_i|)(xi_j - xi_i) for i \in C_s1, and j \in C_s2
      ...
      xi_pdiff{k_1, k_2}, 1, agents_info.num_agents(k_2), sys_info.kappaXi(k_2));
    end
  end
end
end