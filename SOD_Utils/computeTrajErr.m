function trajErr = computeTrajErr( sys_info, syshat_info, solver_info, obs_info, y_init )
...
traj                        = zeros(sys_var_len, obs_info.L, M);
trajfut                     = zeros(sys_var_len, obs_info.L, M);
...
trajhat                     = zeros(sys_var_len, obs_info.L, M);
trajfuthat                  = zeros(sys_var_len, obs_info.L, M);
