...
[learn_out.Estimator.phiEhatsmooth, learn_out.Estimator.Ebasis2] ...
= regularizeInfluenceFunction(learn_out.Estimator.phiEhat, learn_out.Estimator.Ebasis, learn_out.rhoLTemp.rhoLTE, learn_info.sys_info );
