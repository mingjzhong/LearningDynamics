function prepare_JPL_daily_data()
% function prepare_JPL_daily_data()
...
load_time                          = tic;
file_names                         = {'Pluto', 'Neptune', 'Uranus', 'Saturn', 'Jupiter', 'Sun', ...
                                      'Mars', 'Earth', 'Venus', 'Mercury', 'Moon'};
path                               = 'D:\planet_data\1600_to_1999_daily\';
[sys_info, solver_info]            = get_JPL_info(file_names); 
x_daily                            = zeros(sys_info.N * sys_info.d, L);
v_daily                            = zeros(sys_info.N * sys_info.d, L);
a_minutely                         = zeros(sys_info.N * sys_info.d, L);
