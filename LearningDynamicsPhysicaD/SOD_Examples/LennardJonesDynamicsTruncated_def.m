...
sys_info.phiE            = {@(r) LJ_truncated_phiE(r, epsilon, r_m)};                               % energy based influence
...
sys_info.T_f             = 0.2;                                                                     % the time for integration, t = T_f should be (most likely) for the system to reach steady state
