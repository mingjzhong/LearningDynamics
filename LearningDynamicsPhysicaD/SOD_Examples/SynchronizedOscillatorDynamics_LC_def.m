...
sys_info.phiE_dim        = 2;
sys_info.phiE_feature    = @(state_i, state_j) SOD_feature_map(state_i, state_j);
sys_info.phiXi           = {@(r, s) SOD_phiXi(r, s, K)};                                            % xi based interaction
sys_info.phiXi_dim       = 2;
sys_info.phiXi_feature   = @(state_i, state_j) SOD_feature_map(state_i, state_j);
