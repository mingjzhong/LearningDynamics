...
r_ctrs       = (rhoLT1D.histedges{1}(2 : end) + rhoLT1D.histedges{1}(1 : end - 1))/2;
s_ctrs       = (rhoLT1D.histedges{2}(2 : end) + rhoLT1D.histedges{2}(1 : end - 1))/2;
z_ctrs       = (rhoLT1D.histedges{3}(2 : end) + rhoLT1D.histedges{3}(1 : end - 1))/2;
