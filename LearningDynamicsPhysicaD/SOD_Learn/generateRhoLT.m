function [rhoLT, Timings] = generateRhoLT(sys_info, solver_info, obs_info, reuse_flag)
% function [rhoLT, Timings] = generateRhoLT(sys_info, solver_info, obs_info, reuse_flag)
%
...
%  rhoLT.Timings = toc(tstart);  % will take care of the timing variable later
  Timings                  = toc(tstart);
  if VERBOSE > 1, fprintf('\n\tEstimation of rhoLT  completed (%.2f seconds).', Timings); end
