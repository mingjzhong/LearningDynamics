...
% Observations
obs_info.L              = 91;                                                                      % observe (equi-spaced) times
...
obs_info.time_vec       = linspace(sys_info.T_0, obs_info.T_L, obs_info.L);                                % time instances at which discrete observation is made
