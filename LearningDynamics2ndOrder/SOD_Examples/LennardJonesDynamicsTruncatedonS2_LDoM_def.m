function Example = LennardJonesDynamicsTruncatedonS2_LDoM_def()
% function Example = LennardJonesDynamicsTruncatedonS2_LDoM_def()
% Define associated terms for Lennard Jones DYNAMICs on S^2

% System
sys_info.name                = 'LennardJonesDynamicsTruncatedonS2';                                 % name of the dynamics
