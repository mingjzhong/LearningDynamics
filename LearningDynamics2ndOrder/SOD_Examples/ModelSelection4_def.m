function Example = ModelSelection4_def()
% function Example = ModelSelection4_def()
% Define associated terms for Model Selection, 1st order vs. 2nd order, 2nd order

% System
sys_info.name            = 'MS4_1stvs2nd_2nd_order';                                                % name of the dynamics
...
sys_info.Fv              = @(x, v, xi, sys_info) MS_friction(v, 1);                                 % non-collective change to v
