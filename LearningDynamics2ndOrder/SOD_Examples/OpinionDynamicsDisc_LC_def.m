function Example = OpinionDynamicsDisc_LC_def()
% function Example = OpinionDynamicsDisc_LC_def()
% Define associated terms for OPINION DYNAMICS Discontinuous

% System
sys_info.name            = 'OpinionDynamicsDisc2D';                                                   % name of the dynamics
...
sys_info.T_f             = 50;                                                                      % final time the system will reach steady state
sys_info.LC_type         = 'Clustering';
% sys_info.LC_subtype      = 'Consensus';
% ODE solver
